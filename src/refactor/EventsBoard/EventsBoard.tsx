...
import { usePropsEventsBoard } from '@/refactor/EventsBoard/hooks/usePropsEventsBoard';
import { BoardItem } from '@/refactor/EventsBoard/views/BoardItem';
import { BoarTitle } from '@/refactor/EventsBoard/views/BoarTitle';
