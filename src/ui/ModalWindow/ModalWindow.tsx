...
export const ModalWindow = ({ children, show, onClose, title }: Props) => {
  return (
    <Transition appear show={show} as={Fragment}>
      <Dialog as='div' className={`fixed inset-0 z-1000 overflow-y-auto ${sansationFont.className}`} onClose={onClose}>
