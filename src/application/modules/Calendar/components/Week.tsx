...
import { Day } from '@/application/modules/Calendar/components/Day';
import { ruWeekNames } from '@/application/modules/Calendar/constants';
import {
  endDateCalendarSelector,
  startDateCalendarSelector,
  weekCalendarSelector,
} from '@/application/modules/Calendar/store/calendarSelectors';
